...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'P7bH7x71w1pRIAa4', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/ecommerce.css", // Project stylesheet file name
    ...
    "ADMIN_USER_NAME" => "huymanh", // Administrator user name
    "ADMIN_PASSWORD" => "huymanh", // Administrator password
