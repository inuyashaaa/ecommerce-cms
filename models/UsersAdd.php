...
class UsersAdd extends Users
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->avatar->CurrentValue = null;
        $this->avatar->OldValue = $this->avatar->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['avatar'] = $this->avatar->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // avatar
        $this->avatar->setDbValueDef($rsnew, $this->avatar->CurrentValue, null, false);
