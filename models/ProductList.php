...
class ProductList extends Product
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->product_image_file->AdvancedSearch->toJson(), ","); // Field product_image_file
        $filterList = Concat($filterList, $this->price->AdvancedSearch->toJson(), ","); // Field price
        $filterList = Concat($filterList, $this->sale->AdvancedSearch->toJson(), ","); // Field sale
        $filterList = Concat($filterList, $this->color->AdvancedSearch->toJson(), ","); // Field color
        $filterList = Concat($filterList, $this->style->AdvancedSearch->toJson(), ","); // Field style
        $filterList = Concat($filterList, $this->shown->AdvancedSearch->toJson(), ","); // Field shown
        $filterList = Concat($filterList, $this->star->AdvancedSearch->toJson(), ","); // Field star
    ...
    protected function restoreFilterList()
    {
        ...
        // Field product_image_file
        $this->product_image_file->AdvancedSearch->SearchValue = @$filter["x_product_image_file"];
        $this->product_image_file->AdvancedSearch->SearchOperator = @$filter["z_product_image_file"];
        $this->product_image_file->AdvancedSearch->SearchCondition = @$filter["v_product_image_file"];
        $this->product_image_file->AdvancedSearch->SearchValue2 = @$filter["y_product_image_file"];
        $this->product_image_file->AdvancedSearch->SearchOperator2 = @$filter["w_product_image_file"];
        $this->product_image_file->AdvancedSearch->save();
        ...
        // Field sale
        $this->sale->AdvancedSearch->SearchValue = @$filter["x_sale"];
        $this->sale->AdvancedSearch->SearchOperator = @$filter["z_sale"];
        $this->sale->AdvancedSearch->SearchCondition = @$filter["v_sale"];
        $this->sale->AdvancedSearch->SearchValue2 = @$filter["y_sale"];
        $this->sale->AdvancedSearch->SearchOperator2 = @$filter["w_sale"];
        $this->sale->AdvancedSearch->save();
        ...
        // Field style
        $this->style->AdvancedSearch->SearchValue = @$filter["x_style"];
        $this->style->AdvancedSearch->SearchOperator = @$filter["z_style"];
        $this->style->AdvancedSearch->SearchCondition = @$filter["v_style"];
        $this->style->AdvancedSearch->SearchValue2 = @$filter["y_style"];
        $this->style->AdvancedSearch->SearchOperator2 = @$filter["w_style"];
        $this->style->AdvancedSearch->save();

        // Field shown
        $this->shown->AdvancedSearch->SearchValue = @$filter["x_shown"];
        $this->shown->AdvancedSearch->SearchOperator = @$filter["z_shown"];
        $this->shown->AdvancedSearch->SearchCondition = @$filter["v_shown"];
        $this->shown->AdvancedSearch->SearchValue2 = @$filter["y_shown"];
        $this->shown->AdvancedSearch->SearchOperator2 = @$filter["w_shown"];
        $this->shown->AdvancedSearch->save();

        // Field star
        $this->star->AdvancedSearch->SearchValue = @$filter["x_star"];
        $this->star->AdvancedSearch->SearchOperator = @$filter["z_star"];
        $this->star->AdvancedSearch->SearchCondition = @$filter["v_star"];
        $this->star->AdvancedSearch->SearchValue2 = @$filter["y_star"];
        $this->star->AdvancedSearch->SearchOperator2 = @$filter["w_star"];
        $this->star->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->product_image_file, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->price, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->sale, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->color, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->style, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->shown, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->product_image_file); // product_image_file
            $this->updateSort($this->price); // price
            $this->updateSort($this->sale); // sale
            $this->updateSort($this->color); // color
            $this->updateSort($this->star); // star
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->gender->setSort("");
                $this->name->setSort("");
                $this->product_image_file->setSort("");
                $this->price->setSort("");
                $this->sale->setSort("");
                $this->color->setSort("");
                $this->style->setSort("");
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->product_image_file->UseColorbox) {
                ...
                $this->product_image_file->LinkAttrs["data-rel"] = "product_x" . $this->RowCount . "_product_image_file";
