...
class Users extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('users', 'users', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // avatar
        $this->avatar = new DbField('users', 'users', 'x_avatar', 'avatar', '`avatar`', '`avatar`', 200, 255, -1, false, '`avatar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // gender
        $this->gender = new DbField('users', 'users', 'x_gender', 'gender', '`gender`', '`gender`', 202, 6, -1, false, '`gender`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // birthday
        $this->birthday = new DbField('users', 'users', 'x_birthday', 'birthday', '`birthday`', CastDateFieldForLike("`birthday`", 0, "DB"), 135, 19, 0, false, '`birthday`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone
        $this->phone = new DbField('users', 'users', 'x_phone', 'phone', '`phone`', '`phone`', 200, 100, -1, false, '`phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated_at
        $this->updated_at = new DbField('users', 'users', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->updated_at->Sortable = true; // Allow sort
        $this->updated_at->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->updated_at->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
