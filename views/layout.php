...
<link rel="stylesheet" type="text/css" href="<?= $basePath ?><?= CssFile(Config("PDF_STYLESHEET_FILENAME")) ?>">
<?php } ?>
<script src="<?= $basePath ?>js/custom-elements-es5-adapter.js"></script>
<script>
window.WebComponents = window.WebComponents || {};
window.WebComponents.root = "<?= $basePath ?>js/";
</script>
<script src="<?= $basePath ?>js/webcomponents-loader.js"></script>
...
Object.assign(ew, {
    ...
    API_FIELD_NAME: "<?= Config("API_FIELD_NAME") ?>", // API field name
    API_KEY_NAME: "<?= Config("API_KEY_NAME") ?>", // API key name
...
ew.ready("moment", ew.PATH_BASE + "js/chartjs-plugin-datalabels.min.js", "datalabels");
</script>
...
<meta name="generator" content="PHPMaker 2021.0.1">
</head>
