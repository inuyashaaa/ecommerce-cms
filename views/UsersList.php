...
<?php if ($Page->avatar->Visible) { // avatar ?>
        <th data-name="avatar" class="<?= $Page->avatar->headerCellClass() ?>"><div id="elh_users_avatar" class="users_avatar"><?= $Page->renderSort($Page->avatar) ?></div></th>
<?php } ?>
...
<?php if ($Page->gender->Visible) { // gender ?>
        <th data-name="gender" class="<?= $Page->gender->headerCellClass() ?>"><div id="elh_users_gender" class="users_gender"><?= $Page->renderSort($Page->gender) ?></div></th>
<?php } ?>
<?php if ($Page->birthday->Visible) { // birthday ?>
        <th data-name="birthday" class="<?= $Page->birthday->headerCellClass() ?>"><div id="elh_users_birthday" class="users_birthday"><?= $Page->renderSort($Page->birthday) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_users_avatar">
...
<span id="el<?= $Page->RowCount ?>_users_gender">
...
<span id="el<?= $Page->RowCount ?>_users_birthday">
